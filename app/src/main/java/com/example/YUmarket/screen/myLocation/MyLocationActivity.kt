...
import com.example.YUmarket.databinding.ActivityMyLocationBinding
...
class MyLocationActivity :
    BaseActivity<ActivityMyLocationBinding>()//, OnMapReadyCallback
{
    private val viewModel by viewModel<MyLocationViewModel> {
        parametersOf(
