...
class DefaultMapRepository : MapRepository {
    ...
    private val testStores = arrayListOf(
        MapMarketModel(0, "부부식당", LatLng(35.84276976076099, 128.75035319046196),10.0f, testStoreItems0),
        MapMarketModel(1, "오빠야찜닭", LatLng(35.8431743483104, 128.74862612604866),10.0f, testStoreItems1),
        MapMarketModel(2, "커피플레이스", LatLng(35.84115830558572, 128.7540212700628), 10.0f, testStoreItems2, "영남대점"),
        MapMarketModel(3, "오빠야찜닭3", LatLng(35.8421843483104, 128.74862612604866),10.0f, testStoreItems1),
        MapMarketModel(4, "오빠야찜닭4", LatLng(35.8441943483104, 128.74862612604866),10.0f, testStoreItems2),
        MapMarketModel(5, "오빠야찜닭5", LatLng(35.8451643483104, 128.74862612604866),10.0f, testStoreItems2),
    )
